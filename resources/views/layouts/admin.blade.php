...
<head>
    ...
    <title>@yield('title', 'AdminLTE v4 | Dashboard')</title></title>
    ...
    <main class="app-main">
        ...
        {{--<div class="app-content-header">
            ...
            <div class="container-fluid">
                <!--begin::Row-->
                <div class="row">
                    <div class="col-sm-6"><h3 class="mb-0">Adminss</h3></div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Adminss</li>
                        </ol>
                    </div>
                </div>
                <!--end::Row-->
...
<script src="{{ asset('/js/alert_timeout.js') }}"></script>
<script src="{{ asset('/js/toggle_password.js') }}"></script>
<script src="{{ asset('/js/init_filemanager.js') }}"></script>
